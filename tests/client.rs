...
mod tests {
    use super::*;
    use rust_mcp_sdk::{ClientCapabilities, ClientRootsCapability, InitializeResult, Notification, Request, Response, ServerCapabilities, ServerInfo, ServerPromptsCapability, ServerResourcesCapability, ServerToolsCapability};
    ...
    fn test_initialize_request_serialization_full() {
        ...
        let client_info = Some(rust_mcp_sdk::ClientInfo {
